...
def create(
    ...
    try:
        repo.create(db, req)
        return JSONResponse(content={"message": "Paket created successfully"}, status_code=201)
...
def update(
    ...
    try:
        ...
        return JSONResponse(content={"message": "Paket updated successfully"}, status_code=200)
    except HTTPException as e:
        return JSONResponse(status_code=e.status_code, content={"errors": e.detail})
...
def delete(
    ...
    try:
        ...
        return JSONResponse(content={"message": "Paket deleted successfully"}, status_code=200)
    except HTTPException as e:
        return JSONResponse(status_code=e.status_code, content={"errors": e.detail})
